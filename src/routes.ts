...
const models: TsoaRoute.Models = {
    ...
    "User": {
        "properties": {
            ...
            "userRoles": { "dataType": "array", "array": { "ref": "UserRole" } },
        },
    },
    "Sheriff": {
        "properties": {
    ...
    "Role": {
        "properties": {
            ...
            "updatedDtm": { "dataType": "string" },
            "revisionCount": { "dataType": "double" },
            "roleFrontendScopes": { "dataType": "array", "array": { "ref": "RoleFrontendScope" } },
            "roleApiScopes": { "dataType": "array", "array": { "ref": "RoleApiScope" } },
        },
    },
    "UserRole": {
        "properties": {
...
export function RegisterRoutes(router: any) {
    ...
    router.post('/v1/codes/jailroles',
        authenticateMiddleware([{ "name": "jwt" }]),
        async (context, next) => {
            const args = {
    ...
    router.delete('/v1/codes/jailroles/:id',
        ...
        async (context, next) => {
            ...
            const promise = controller.deleteJailRoleCode.apply(controller, validatedArgs);
            return promiseHandler(controller, promise, context, next);
        });
    ...
    router.post('/v1/codes/otherassign',
        authenticateMiddleware([{ "name": "jwt" }]),
        async (context, next) => {
            const args = {
                model: { "in": "body", "name": "model", "required": true, "ref": "OtherAssignCode" },
            };
    ...
    router.delete('/v1/codes/otherassign/:id',
        ...
        async (context, next) => {
            ...
            const promise = controller.deleteOtherAssignCode.apply(controller, validatedArgs);
            return promiseHandler(controller, promise, context, next);
        });
    ...
    router.get('/v1/codes/leave-sub-type/:id',
        authenticateMiddleware([{ "name": "jwt" }]),
        async (context, next) => {
            const args = {
                id: { "in": "path", "name": "id", "required": true, "dataType": "string" },
            ...
            const promise = controller.getLeaveSubCodeById.apply(controller, validatedArgs);
            return promiseHandler(controller, promise, context, next);
        });
    router.post('/v1/codes/leave-sub-type',
        authenticateMiddleware([{ "name": "jwt" }]),
        async (context, next) => {
            const args = {
                model: { "in": "body", "name": "model", "required": true, "ref": "LeaveSubCode" },
            };
    ...
    router.delete('/v1/codes/leave-sub-type/:id',
        ...
        async (context, next) => {
            ...
            const promise = controller.deleteLeaveSubCode.apply(controller, validatedArgs);
            return promiseHandler(controller, promise, context, next);
        });
    ...
    router.post('/v1/codes/courtroles',
        authenticateMiddleware([{ "name": "jwt" }]),
        async (context, next) => {
            const args = {
                model: { "in": "body", "name": "model", "required": true, "ref": "CourtRoleCode" },
            };
    ...
    router.delete('/v1/codes/courtroles/:id',
        ...
        async (context, next) => {
            ...
            const promise = controller.deleteCourtRoleCode.apply(controller, validatedArgs);
            return promiseHandler(controller, promise, context, next);
        });
