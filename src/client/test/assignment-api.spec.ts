...
describe('Assignment API', () => {
    ...
    it('expiring a duty recurrence should hide it from the assignments list',async ()=>{
        ...
        expect(retrievedById.dutyRecurrences).toEqual(expect.arrayContaining([firstRecurrence,secondRecurrence]));
